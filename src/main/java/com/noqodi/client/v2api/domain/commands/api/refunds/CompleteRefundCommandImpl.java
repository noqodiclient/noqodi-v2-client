...
import com.noqodi.client.v2api.domain.models.common.CompletePayRequestModel;
...
@Service
public class CompleteRefundCommandImpl extends AbstractApiCommand<CompletePayRequestModel, RefundResponseModel> {
    ...
    @Autowired
    public CompleteRefundCommandImpl(GetAccessTokenCCGCommandImpl accessTokenBaseCommand) {
        super(accessTokenBaseCommand);
    }

    @Override
    public RemoteOperationModel<CompletePayRequestModel, RefundResponseModel> handle(CompletePayRequestModel requestModel, AccessTokenResponseModel accessTokenResponseModel) {
        ...
        RestTemplateParameters<CompletePayRequestModel, RefundResponseModel> restTemplateParameters =
    ...
    @Override
    public RemoteOperationModel<CompletePayRequestModel, RefundResponseModel> buildResponse(CompletePayRequestModel requestModel, RefundResponseModel responseModel, ResponseEntity responseEntity) {
    ...
    private String getRequestUrl(CompletePayRequestModel requestModel) {
        return Helper.buildUrl(
                configuration.getBaseUrl(),
                null,
                configuration.getEndpoints().getRefundsUris().getCompleteRefundsUri()
        );
    }

    @Override
    public void validate(CompletePayRequestModel requestModel) throws NoqodiValidationException {
    ...
    @Override
    public void preHandle(CompletePayRequestModel requestModel) {

    }

    @Override
    public void postHandle(RemoteOperationModel<CompletePayRequestModel, RefundResponseModel> remoteOperationModel) {
    ...
    @Override
    public RemoteOperationModel<CompletePayRequestModel, RefundResponseModel> buildTokenErrorResponse(CompletePayRequestModel requestModel, RemoteOperationModel<AbstractAccessTokenRequestModel, AccessTokenResponseModel> tokenOperationModel) {
    ...
    @Override
    public RemoteOperationModel<CompletePayRequestModel, RefundResponseModel> handleError(CompletePayRequestModel requestModel, RefundResponseModel responseModel, Exception exception) {
        return this.buildResponse(
                requestModel,
